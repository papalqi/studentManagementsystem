...
alter table classTimeTable
   drop constraint FK_CLASSTIM_CLASSTIME_CLASSROO;

alter table classTimeTable
   drop constraint FK_CLASSTIM_CLASSTIME_COURSE;
...
alter table teacher
   drop constraint FK_TEACHER_RELATIONS_COLLEGE;
...
(
   ...
   iCampusID            INTEGER,
   nacademicBuildingName VARCHAR2(10)         not null,
...
(
   ...
   iTeachClassID        INTEGER              not null,
   iWeekNumber          INTEGER              not null,
   week                 INTEGER              not null,
   section              INTEGER              not null,
   constraint PK_CLASSTIMETABLE primary key (iClassRoomID, iTeachClassID)
);

/*==============================================================*/
/* Index: classOccupy_FK                                        */
/*==============================================================*/
create index classOccupy_FK on classTimeTable (
   iClassRoomID ASC
);
...
/*==============================================================*/
create index classOccupy2_FK on classTimeTable (
   iTeachClassID ASC
);
...
/*==============================================================*/
create index Relationship_3_FK on major (
   iCollegeID ASC
);
...
/*==============================================================*/
create index Relationship_16_FK on teacher (
   iCollegeID ASC
);
...
alter table classTimeTable
   add constraint FK_CLASSTIM_CLASSTIME_CLASSROO foreign key (iClassRoomID)
      references classroom (iClassRoomID);

alter table classTimeTable
   add constraint FK_CLASSTIM_CLASSTIME_COURSE foreign key (iTeachClassID)
      references course (iTeachClassID);
...
alter table teacher
   add constraint FK_TEACHER_RELATIONS_COLLEGE foreign key (iCollegeID)
      references college (iCollegeID);
