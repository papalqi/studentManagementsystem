...
//		console.log(view_stuname);
		...
		$("#stuname").val(localStorage.stuname);
		$("#stuid").val(localStorage.stuid);
	...
	$("#major_list").change(function(){
		...
		$("#change_student_btn").click(function(){
 		...
 		$.ajax({
                url:"http://192.168.1.187:8080/studentgrade/UpdateStudent?cookie="+cookie+"&stuid="+stuid+"&stuname="+stuname+"&classid="+classid,
                type:"get",
                xhrFields: {  
                        withCredentials: true  
                    }, 
