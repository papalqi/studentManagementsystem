...
//                  	console.log("http://192.168.1.187:8080/studentgrade/SelectTeacher?cookie="+cookie+"&context=");
            ...
            $.ajax({
                url:"http://192.168.1.187:8080/studentgrade/DeleteTeacher?cookie="+cookie+"&teaid="+teaid,
                type:"get",
                xhrFields: {  
                        withCredentials: true  
                    }, 
...
//                  	console.log(data.stuname);
                    	...
                    	document.teacher_manange_form.action="admin_teacher_view.html";
                    	$(".am-form").submit();
...
//                  	console.log(data.stuname);
						...
						localStorage.teaphoneno = data.teaphoneno;
						localStorage.teamail = data.teamail;
                    	document.teacher_manange_form.action="admin_teacher_change.html";
                    	$(".am-form").submit();
