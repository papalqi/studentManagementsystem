...
public class CourseT {
    ...
    public void setScouesestate(String scouesestate) {
        this.scouesestate = scouesestate == null ? null : scouesestate.trim();
    }

    public byte[] getBscorestate() {
        return bscorestate;
    }

    public void setBscorestate(byte[] bscorestate) {
